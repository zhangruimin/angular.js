describe('Scope', function(){
  ...
  describe('$parent', function(){
    ...
    it('should point to parent', function(){
      ...
      expect(root.$new().$parent).toEqual(root);
    });
  });
  ...
  describe('$watch/$digest', function(){
    ...
    it('should fire watches as long as we have changes', function(){
      root.$watch('c', function(self, v){self.d = v;});
      root.$watch('b', function(self, v){self.c = v;});
      root.$watch('a', function(self, v){self.b = v;});
      root.a = 1;
    ...
    it('should prevent infinite recursion', function(){
      ...
      expect(function(){
        root.$digest();
      }).toThrow('Maximum iteration limit exceeded.');
    });
  ...
  describe('$observe/$flush', function(){
    it('should observe and fire on simple property change', function(){
      var spy = jasmine.createSpy();
      root.$observe('name', spy);
      expect(spy).not.wasCalled();
      root.$flush();
      expect(spy).wasCalledWith(root, undefined, {});
      root.name = 'misko';
      root.$flush();
      expect(spy).wasCalledWith(root, 'misko', undefined);
    });

    it('should observe and fire on expression change', function(){
      var spy = jasmine.createSpy();
    ...
    it('should fire observees in order of addition', function(){
      var log = '';
    ...
    it('should only fire observers once', function(){
      root.$observe('c', function(self, v){self.d = v;});
      root.$observe('b', function(self, v){self.c = v;});
      root.$observe('a', function(self, v){self.b = v;});
      root.a = 1;
      root.$flush();
      expect(root.b).toEqual(1);
      root.$flush();
